function [] = UpdateUEL_v3(UELDir,nT,nmax, matpath, jobnum)

% Read txt into cell A
DefaultUELDir = [UELDir,'UEL_BeamCoupling_v3.f'];
...
% Change values
A{15} = sprintf('	  PARAMETER (nT=%d,nM=%d)', [nT,nmax]);
A{46} = sprintf('	  PARAMETER (nT=%d,nM=%d)', [nT,nmax]);
