function [] = D01_WriteAbaqusInput_RPL(WorkDir, JobNum, SolidMesh, BeamMesh, PenaltyConst, BeamRadius, param_beam, disp_mode ,X_disp, nSteps, Matl, param_solid, beam_nu, CoupleElemCon, nmax, nT, SolverOptions,RPL)
...
elseif strcmp(RPL, 'UEy') || strcmp(RPL, 'SSxy') || strcmp(RPL, 'SSyz')
...
E11 = setxor(intersect(NX,NZ),[C3,C5]);
