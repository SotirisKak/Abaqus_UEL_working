function [] = D02_WriteAbaqusInput_PerBCs(WorkDir, JobNum, SolidMesh, BeamMesh, PenaltyConst, BeamRadius, param_beam, disp_mode ,X_disp, nSteps, Matl, param_solid, beam_nu, CoupleElemCon, nmax, nT, SolverOptions)
...
fprintf(fid, '\t 9999991,0,0,0 \n');
fprintf(fid, '\t 9999992,0,0,0 \n');
fprintf(fid, '\t 9999993,0,0,0 \n');
%% Solid Node Sets
...
fprintf(fid, '%i \n', ntotal+2);
fprintf(fid, '*NSET, NSET=DEF\n');
fprintf(fid, '9999991,9999992,9999993  \n');
...
fprintf(fid,'%d,2,1\n',CoupleElemCon.A(4,3));
fprintf(fid,'%d,2,-1\n',CoupleElemCon.A(4,4));
fprintf(fid,'9999991,2,-120\n');
fprintf(fid,'*Equation\n');
fprintf(fid,'3\n');
fprintf(fid,'%d,2,1\n',CoupleElemCon.A(4,5));
fprintf(fid,'%d,2,-1\n',CoupleElemCon.A(4,6));
fprintf(fid,'9999992,2,-120\n');
fprintf(fid,'*Equation\n');
fprintf(fid,'3\n');
fprintf(fid,'%d,2,1\n',CoupleElemCon.A(4,7));
fprintf(fid,'%d,2,-1\n',CoupleElemCon.A(4,8));
fprintf(fid,'9999993,2,-120\n');
%% Materials
fprintf(fid, '** \n');
...
for i = 1:nSteps
   ...
   % fprintf(fid, '*Static, STABILIZE, factor=1e-5\n');
    ...
    fprintf(fid, '*Boundary \n');
    fprintf(fid, '9999991, 2,3,0\n');
    fprintf(fid, '9999992, 1,1,0\n');
    fprintf(fid, '9999992, 2,2,-0.3\n');
    fprintf(fid, '9999992, 3,3,0\n');
    fprintf(fid, '9999993, 1,2,0\n');
